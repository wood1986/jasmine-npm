...
function Command(projectBaseDir, examplesDir, print) {
  ...
  this.run = function(newJasmine, commands) {
    ...
    if (commandToRun) {
      commandToRun.action({jasmine: newJasmine(), projectBaseDir: command.projectBaseDir, specDir: command.specDir, examplesDir: examplesDir, print: print});
    } else {
